(function() {
	...
	var Player = Mario.Player = function(pos) {
		...
		this.sprite.renderSize = [24,48];
		this.sprite.renderOffset = [-4,-32];
		this.sprite.faceOverlay = { img: 'sprites/face-head.png', x: 0, y: 0, width: 24, height: 26 };
	};
  ...
  Player.prototype.setAnimation = function() {
		...
		if (this.starTime) this.starTime -= 1;
